export default function ProjectIcon({ isActive }){
    const fillColor = isActive ? '#DBCBE5' : '#332E84';
    const strokeColor = isActive ? '#332E84' : '#DBCBE5';
    
    return (
        <svg width="38" height="38" viewBox="0 0 55 54" fill="none" xmlns="http://www.w3.org/2000/svg">
